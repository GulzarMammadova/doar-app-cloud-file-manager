...
export function Header() {
  ...
  const handleSearchTextChange = (searchText) => {
    ...
    const filteredResults = allFilesList.filter((file) =>
  ...
  return (
    <div className="header">
      ...
      <div className="nav-menu">
        <SearchBar onTextChange={handleSearchTextChange} filteredFiles={filteredFiles}/>
      </div>
      ...
      <div className="div">
       {filteredFiles.map((file) => (
                    <div key={file.id} className="filtered-file">
                    </div>
                ))}
      </div>
    </div>
